...
class HtmlEditor(forms.Textarea):
    ...
    class Media:
        ...
        js = (
            ...
            'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.44.0/mode/xml/xml.js',
            'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.44.0/mode/markdown/markdown.js',
